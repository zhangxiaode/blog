    ...
    return (
      <div className="richText">
        <div className="richBtn">
          ...
          <button onClick={this.italicClick} title="标题 (Ctrl+Alt+1)">
          ...
          <button onClick={this.italicClick} title="引用块 (Ctrl+Shift+U)">
          ...
          <button onClick={this.italicClick} title="代码块 (Ctrl+Alt+C)">
          ...
          <button onClick={this.italicClick} title="上传视频">
          ...
          <button onClick={this.italicClick} title="插入公式 (Ctrl+Shift+E)">
          ...
          <button onClick={this.italicClick} title="插入分隔线 (Ctrl+Shift+S)">
          ...
          <button onClick={this.italicClick} title="清除格式 (Ctrl+\)">
          ...
          <button onClick={this.italicClick} title="更多" className="more">
